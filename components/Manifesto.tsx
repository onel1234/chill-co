        ...
        <div style={{ maxWidth: '1300px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '680px' }}>
            ...
            <h2 style={{
              ...
              A wearable archive of<br />
              Sri Lankan <span className="gold-text">stories.</span>
            </h2>
            <p style={{ fontSize: '0.88rem', lineHeight: 1.85, color: 'rgba(240,230,211,0.55)', fontWeight: 300, marginBottom: '2.5rem', maxWidth: '500px' }}>
              Each piece is a narrative, woven from the rich tapestry of the island&apos;s heritage. We transform traditional motifs and local craftsmanship into modern streetwear that speaks volumes. It is not just clothing; it is a living history.
            </p>
